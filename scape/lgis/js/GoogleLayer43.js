...
define(["dojo/_base/declare", "esri/layers/WebTileLayer1", "esri/geometry/Extent", "esri/geometry/SpatialReference", "esri/layers/support/TileInfo"],
    function (declare, WebTileLayer, Extent, SpatialReference, TileInfo) {
        return declare(WebTileLayer, {
            normalizeCtorArgs: function (a, b) {
                return "string" === typeof a ? e.mixin({ urlTemplate: a }, b || {}) : a
            },
            getDefaults: function (layerUrl) {
                debugger;
            ...
            getTileUrl: function (level, row, col) {
                ...
                if (this.layerUrl == "http-map")
                    ...
                    return "http://google.cn/maps/vt/lyrs=s@708&gl=cn&x=" + col + "&y=" + row + "&z=" + level + "&s=";
                else
                    return this.layerUrl + level + "/" + col + "/" + row + ".png";
            }
        });
    }
)
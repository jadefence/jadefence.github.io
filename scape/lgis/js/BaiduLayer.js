        ...
        return declare(TiledMapServiceLayer, {
            ...
            getTileUrl: function (level, row, col) {
                ...
                if (this.layerUrl == "http-map") {
                    //return "http://online2.map.bdimg.com/onlinelabel/?qt=tile&x=" + numX + "&y=" + numY + "&z=" + level + "&styles=pl&udt=20161216&scaler=1&p=0";
                    return "http://online" + num + ".map.bdimg.com/tile/?qt=tile&x=" + numX + "&y=" + numY + "&z=" + level + "&styles=pl&scaler=1&udt=20141103";
                }
                else if (this.layerUrl == "http-map-mark")
                    ...
                    return "http://shangetu" + num + ".map.bdimg.com/it/u=x=" + numX + ";y=" + numY + ";z=" + level + ";v=009;type=sate&fm=46&udt=20150504&app=webearth2&v=009&udt=20150601";
                else
                    return this.layerUrl + level + "/" + numX + "/" + numY + ".png";
            }
        });
    }
)